...
import { activities, currentlyWatching, currentlyListening } from "@/data/activities"
        ...
        <div className="aspect-[3/4] w-full relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-3">
            <div className="flex items-center space-x-1 mb-1">
              ...
              >
                {icon}
                <span className="ml-1">{isWatching ? item.network : "TRACK"}</span>
              </div>
            ...
            <p className="text-xs text-gray-300 mt-0.5 truncate">{isWatching ? item.genre : item.artist}</p>
          </div>
        </div>
      </div>
