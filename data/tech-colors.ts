export const techColors: Record<string, string> = {
  ...
  typescript: "#3178c6",
  react: "#61dafb",
  "next.js": "#ffffff", // Often represented by white or black depending on theme
  "node.js": "#339933",
  tailwindcss: "#38b2ac",
  graphql: "#e10098", // Keeping existing colors
  rust: "#dea584", // Keeping existing colors
  ...
  // Added colors for technologies in your projects:
  c: "#656565", // Common representation for C
  python: "#3776AB", // Common Python color
  flask: "#cccccc", // Neutral color for Flask
